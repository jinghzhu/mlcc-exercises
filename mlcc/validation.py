...
# For training set, choose the first 12000 examples, out of the total of 17000.
...
# For validation set, choose the last 5000 examples, out of the total of 17000.
...
"""
Step 2: Plot Latitude/Longitude vs. Median House Value
"""
...
# Train a linear regressor using all the features in the data set
...
# Because now working with multiple input features, modularize code for configuring feature columns into
# separate function.
