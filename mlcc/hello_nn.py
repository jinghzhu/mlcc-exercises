# 1. Define a neural network (NN) and its hidden layers using the TensorFlow DNNRegressor class
# 2. Train neural network to learn non-linearities in dataset and achieve better performance than linear regression.
...
# 1. The first hidden layer contains 3 nodes.
# 2. The second hidden layer contains 10 nodes.
#
