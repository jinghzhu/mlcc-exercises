...
"""
# Visualize the performance of model by creating a scatter plot of predictions vs. target values.
# Ideally, these would lie on a perfectly correlated diagonal line.
plt.figure(figsize=(15, 6))
plt.subplot(1, 2, 1)
plt.scatter(calibration_data["predictions"], calibration_data["targets"])
# If plot a histogram of rooms_per_person, have a few outliers in input data:
plt.subplot(1, 2, 2)
...
"""
# Further improve model fit by setting outlier values of rooms_per_person to some reasonable minimum or maximum.
california_housing_dataframe["rooms_per_person"] = (
